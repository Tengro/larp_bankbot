...
HACKER_MESSAGE_DIFFICULY = my_config_parser.getint("BOT_HACKER_SETTINGS", "HACKER_MESSAGE_DIFFICULY")
HACKER_COMMON_DIFFICULTY = my_config_parser.getint("BOT_HACKER_SETTINGS", "HACKER_COMMON_DIFFICULTY")
